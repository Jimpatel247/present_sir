        ...
        querySnapshot.forEach((sub)=>{
          // console.log(sub.data());
            ...
            if(list.length!=0){
              ...
              const ind=subjects.findIndex((ele)=>{ele.subject == sub.data().subject})
              if(ind!=-1 ){
                  var tot=subjects[ind].total+newTeacher.total;
                  var att=subjects[ind].attended+newTeacher.attended;
